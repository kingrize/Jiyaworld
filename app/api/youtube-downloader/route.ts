 ...
 * - RAPID_API_KEY: Your RapidAPI key for youtube-media-downloader
 * - RAPID_API_HOST: (optional) API host, defaults to youtube-media-downloader.p.rapidapi.com
 */
...
export async function POST(req: Request) {
  try {
    ...
    if (!apiKey) {
      console.error("[YouTube-Downloader] RAPID_API_KEY is not configured in environment variables.");
